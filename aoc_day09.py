...
print(9, 25, play_marbles_fast(9, 25))
print(10, 1618, play_marbles_fast(10, 1618))
...
print(13, 7999, play_marbles_fast(13, 7999))
print(17, 1104, play_marbles_fast(17, 1104))
print(21, 6111, play_marbles_fast(21, 6111))
print(30, 5807, play_marbles_fast(30, 5807))


# # 432 players; last marble is worth 71019 points        
print('Solution 9.1:', play_marbles_fast(432, 71019))
...
print('Solution 9.2:', play_marbles_fast(432, 7101900))